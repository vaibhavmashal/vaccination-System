...
public class Register extends JFrame {
	...
	public Register() {
		...
		lblNewLabel_5.setBounds(662, 377, 197, 34);
		contentPane.add(lblNewLabel_5);
		
		JLabel Address = new JLabel("Address :");
		Address.setFont(new Font("Segoe UI Semibold", Font.BOLD, 19));
		Address.setBounds(865, 408, 197, 34);
		...
		rdbtnNewRadioButton.setBounds(672, 417, 103, 21);
		...
		rdbtnFemale.setBounds(672, 452, 103, 21);
		...
		rdbtnTrans.setBackground(new Color(230, 230, 250));
		bg.add(rdbtnTrans);
		rdbtnTrans.setFont(new Font("Tahoma", Font.BOLD, 15));
		rdbtnTrans.setBounds(672, 491, 103, 21);
		contentPane.add(rdbtnTrans);
		
		JLabel lblNewLabel_7 = new JLabel("New label");
		lblNewLabel_7.setHorizontalAlignment(SwingConstants.CENTER);
		Image img1 = new ImageIcon(this.getClass().getResource("/write.png")).getImage();
		...
		mobileNo.setBounds(626, 313, 197, 33);
		...
		emailerr.setBounds(865, 313, 177, 33);
		...
		req3.setBounds(1094, 197, 165, 21);
...
//				match = ptr.matcher(pw.getText());
		...
		lblNewLabel_3_1_1_1.setBounds(1094, 336, 197, 34);
